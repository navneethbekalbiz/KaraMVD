              ...
              <div className="w-full md:w-1/2 text-center relative">
                <Reveal delay={0.3}>
                  <div className="flex flex-col items-center">
                    <span className="font-display text-[8rem] md:text-[12rem] text-gold/40 absolute -top-24 md:-top-32 left-1/2 -translate-x-1/2 select-none z-0">0{index + 1}</span>
                    <span className="font-sans text-xs tracking-[0.2em] text-gold uppercase mb-6 relative z-10 font-semibold">Specialized Care</span>
