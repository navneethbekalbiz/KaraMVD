...
const QUESTIONS: Question[] = [
    {
        ...
        type: 'options',
        options: ["Anti-Aging & Rejuvenation", "Acne, Scars & Pigmentation", "Unwanted Hair or Thinning", "Skin Glow & Maintenance"]
    },
    {
        id: 2,
    ...
    },
    {
        ...
        type: 'options',
        options: ["Oily / Acne-prone", "Dry / Sensitive / Dull", "Excess Hair / Mild Thinning", "Mature / Fine Lines"]
    }
];
                                ...
                                >
                                    ...
                                    <div className="bg-white/60 p-6 rounded-2xl border border-obsidian/5 mb-8 max-w-md">
                                        <p className="font-sans text-obsidian/80 leading-relaxed mb-2">
                                            Based on your profile, you are a strong candidate for a <strong>Personalized Clinic Protocol</strong>.
                                        </p>
                        ...
                        {!isAnalyzing && !showResult && (
                            <div className="bg-white/30 border-t border-obsidian/5 p-4 text-center">
                                <p className="font-sans text-[10px] uppercase tracking-widest text-obsidian/50 flex items-center justify-center gap-4">
                                    <span>15k+ Assessments</span> • <span>FDA Approved Protocols</span> • <span>Dr. Rashmi Sharma</span>
                                </p>
                            </div>
                        )}
